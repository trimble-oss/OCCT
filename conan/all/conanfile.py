...
class OpenCascadeConan(ConanFile):
    ...
    default_options = {
        ...
        "with_draco": False,
        "with_tk": False, # TrimbleTech, 2023-12-28
        "with_tbb": False,
        "with_opengl": False, # TrimbleTech, 2023-12-28
    ...
    def requirements(self):
        #self.requires("tcl/8.6.10") - TrimbleTech 2023-12-28
        ...
        #    self.requires("xorg/system") # - TrimbleTech 2023-12-28
    ...
    def _patch_sources(self):
        ...
        ## freetype, TrimbleTech 2023-12-28
...
#pragma comment (lib, "tk"  STRINGIZE2(TCL_MAJOR_VERSION) STRINGIZE2(TCL_MINOR_VERSION) ".lib")""",
    ...
    def build(self):
        CLI_ARGS = ["-UUSE_XLIB", "-DUSE_XLIB=OFF"]
        self._patch_sources()
        cmake = CMake(self)
    ...
    def _get_modules_from_source_code(self):
        ...
        print ("collect_libs", packaged_libs_list)
        for module_line in modules_content.splitlines():
            #print ("jhl: ", module_line)
            components = {}
            module_components = module_line.split()
            print ("jhl: ", module_components)
            #if module_components[0] == "Visualization":
            #    continue
            if module_components[0] == "DETools":
                continue
            if module_components[0] == "Draw":
                continue
            components_list = [component for component in module_components[1:] if component in packaged_libs_list]
            #print("jhl: ", components_list)
            for component_name in components_list:
                #print("\tjhl: ", component_name)
                component_deps = {}
