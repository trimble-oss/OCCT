...
MSBuild ../BuildStatic-142/ALL_BUILD.vcxproj /p:Configuration=Debug /p:Platform=x64
MSBuild ../BuildStatic-142/ALL_BUILD.vcxproj /p:Configuration=RelWithDebInfo /p:Platform=x64
